        ...
        <div className="flex gap-x-3">
          ...
          >
            ...
            <input
              ...
              className="w-[220px] sm:w-[310px] md:w-[410px] border border-[#D1D1D6] focus:outline-none focus:ring-0 py-3 px-9 rounded-[10px]  "
            />
          </form>
        </div>
      </div>
          ...
          <thead>
            <tr className="text-cloud-burst-500 text-center md:text-left border-b-2">
              ...
              <th className="cursor-pointer relative pb-2 pl-4 pr-[12px] md:pr-24">
                Harga
                <img
                  className="absolute left-[113px] md:left-[61px] bottom-[6px] md:bottom-1.5"
                  src={arrowTopDown}
                />
              </th>
