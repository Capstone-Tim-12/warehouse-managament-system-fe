      ...
      <div className="flex justify-end items-center text-white p-5 md:p-10 lg:p-20">
        <div className="flex flex-col gap-y-4 max-w-2xl w-full md:w-[500px]">
          <div className="flex items-center gap-2 md:gap-5">
            <p className="border border-x-[50px] border-[#ffffff]"></p>
          ...
          <div className="bg-white w-full md:w-[525px] h-[161px] flex items-center rounded p-5 md:p-8 gap-5 md:gap-10 text-[#17345F]">
