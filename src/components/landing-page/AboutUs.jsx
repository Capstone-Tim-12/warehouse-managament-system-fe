                ...
                <div className="bg-cloud-burst-500 grid grid-cols-1 lg:grid-cols-2 rounded-2xl">
                    <div className="flex flex-col gap-[55px] p-8 md:p-12 lg:pr-0 lg:p-24">
                        <div className="flex flex-row items-center w-full gap-2">
                            ...
                            <h1 className="text-center text-white text-[25px] md:text-[38px] lg:text-[48px] font-bold">
                                Tentang Kami
                            </h1>
                        </div>
                        <p className="text-white max-w-[550px] md:text-xl text-left lg:text-justify">
