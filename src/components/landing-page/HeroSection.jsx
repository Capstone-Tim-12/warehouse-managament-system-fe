...
const HeroSection = () => {
  return (
    <div id="heroSection">
      <div className="flex flex-col lg:flex-row sm:flex-row pl-6 justify-center lg:justify-evenly h-[500px] md:h-[580px] sm:h-[500px] lg:h-screen overflow-hidden w-full">
